...
export default function ChatPage() {
  ...
  return (
    <div className={`fixed inset-0 flex flex-col bg-linear-to-br from-green-50 via-emerald-50 to-teal-50 transition-transform duration-300 h-dvh ${
      ...
      <div className="flex-1 flex flex-col overflow-hidden min-h-0">
            ...
            <div className="flex items-center gap-2 sm:gap-3 min-w-0">
              ...
              >
                {ripples.map((ripple) => (
                  <span
                    key={ripple.id}
                    className="absolute rounded-full bg-green-400/40 animate-ripple pointer-events-none ripple-span"
                    style={{
                      left: `${ripple.x}px`,
                      top: `${ripple.y}px`,
                      width: '20px',
        ...
        {/* Input - Rounded Style */}
        <div className="px-2 pb-2 sm:px-3 sm:pb-3 shrink-0 safe-area-bottom">
