...
import { User, Trash2, Volume2, VolumeX, Menu, X, Globe, RefreshCw, Sun, Moon } from "lucide-react";
  ...
  return (
    <header className="sticky top-0 z-50 px-3 pt-3">
      <div className="container mx-auto max-w-7xl">
        <div className="bg-gradient-to-br from-emerald-200/40 via-emerald-100/40 to-emerald-200/40 backdrop-blur-2xl shadow-lg rounded-3xl border border-white/40 px-4 md:px-6 py-3 md:py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center gap-2">
              <button
                type="button"
                onClick={() => {
                  if (audioEnabled) speakNative(t('newSession'), language?.browserCode || "en-IN");
                  handleNewSession();
                }}
              ...
              <button
                type="button"
                onClick={() => {
                  if (audioEnabled) speakNative(t('changeLanguage'), language?.browserCode || "en-IN");
        ...
        {menuOpen && (
          <div className="mt-3 md:hidden bg-gradient-to-br from-emerald-200/40 via-emerald-100/40 to-emerald-200/40 backdrop-blur-2xl rounded-2xl shadow-lg border border-white/40 overflow-hidden animate-in slide-in-from-top-2 duration-200">
